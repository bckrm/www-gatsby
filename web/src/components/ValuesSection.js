        ...
        <StyledSection>
            ...
            <StyledGrid>
                ...
                <div className="col-span-8">
                    ...
                    <StyledP>
                        We strive to do the right thing, all the time. Yeah, we
                        know it’s a lot more work that way. From hiring
                        practices internally to making design deisions that
                        impact end users, we intentionally consider every human
                        that will experience the results of our actions—and take
                        it seriously.
                    </StyledP>
                </div>
            </StyledGrid>
